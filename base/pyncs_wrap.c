...
#define SWIG_init    Pyncs_Init
#define SWIG_name    "pyncs"
#define SWIG_prefix  ""
...
extern "C" {
#endif
SWIGINTERN const char *_wrap_std_get(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, char *name1, char *name2, int flags) {
  Tcl_Obj *value = 0;
  
  value = SWIG_NewInstanceObj(SWIG_as_voidptr(&std), SWIGTYPE_p_namespace, 0 );
  if (value) {
...
SWIGINTERN const char *_wrap_std_set(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, char *name1, char *name2 SWIGUNUSED, int flags) {
  Tcl_Obj *value = 0;
  Tcl_Obj *name1o = 0;
...
SWIGINTERN const char *_wrap_ncs_get(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, char *name1, char *name2, int flags) {
  Tcl_Obj *value = 0;
  
  value = SWIG_NewInstanceObj(SWIG_as_voidptr(&ncs), SWIGTYPE_p_namespace, 0 );
  if (value) {
    Tcl_SetVar2(interp,name1,name2,Tcl_GetStringFromObj(value,NULL), flags);
    Tcl_DecrRefCount(value);
  }
...
SWIGINTERN const char *_wrap_ncs_set(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, char *name1, char *name2 SWIGUNUSED, int flags) {
  Tcl_Obj *value = 0;
  Tcl_Obj *name1o = 0;
  ...
  if (!value) SWIG_fail;
  {
    ...
    int res = SWIG_ConvertPtr(value, &argp, SWIGTYPE_p_namespace,  0 );
    if (!SWIG_IsOK(res)) {
      SWIG_exception_fail(SWIG_ArgError(res), "in variable '""ncs""' of type '""namespace""'");
    }
    if (!argp) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in variable '""ncs""' of type '""namespace""'");
    } else {
      ncs = *((namespace *)(argp));
    }
  }
...
static swig_var_info swig_variables[] = {
    { SWIG_prefix "std", 0, (swig_variable_func) _wrap_std_get,(swig_variable_func) _wrap_std_set},
    { SWIG_prefix "ncs", 0, (swig_variable_func) _wrap_ncs_get,(swig_variable_func) _wrap_ncs_set},
    {0,0,0,0}
};
...
SWIGEXPORT int Pyncs_SafeInit(Tcl_Interp *interp) {
